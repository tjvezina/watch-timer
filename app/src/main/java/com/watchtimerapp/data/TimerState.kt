...
sealed class TimerState {
    ...
    data class Alarming(
        val originalDurationMillis: Long,
        val alarmStartMillis: Long = System.currentTimeMillis(),
    ) : TimerState() {
        override fun remainingMillis(): Long = 0L

        fun elapsedMillis(): Long = System.currentTimeMillis() - alarmStartMillis
    }
    ...
    companion object {
        ...
        fun formatElapsedOvertime(millis: Long): String {
